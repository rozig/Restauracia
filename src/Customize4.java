...
public class Customize4 extends javax.swing.JFrame {
    int a1=1,a2=1,total=3000,orts1=0,orts2=0,l1=1,c1=0,c2=1,c3=0,c;
    Connection conn = null;
    ResultSet rs = null;
    PreparedStatement pst=null;
    String m1="VANILLA REDUCED FAT ICE CREAM\n",m2="ICE CREAM CONE\n",n1="",n2="Дунд",n3="";
    public Customize4() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Vanilla Reduced Fat Ice Cream");
        setResizable(false);
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Order/s-mcdonalds-Vanilla-Reduced-Fat-Ice-Cream-Cone.png"))); // NOI18N

        IngredientPanel.setBorder(javax.swing.BorderFactory.createTitledBorder("Орц"));

        Ingredient1Check.setSelected(true);
        Ingredient1Check.setText("VANILLA REDUCED FAT ICE CREAM");
        ...
        Ingredient2Check.setText("ICE CREAM CONE");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(SizePanel, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            ...
                            .addComponent(IngredientPanel, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(0, 0, Short.MAX_VALUE)))
                .addContainerGap())
            .addGroup(layout.createSequentialGroup()
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(IngredientPanel, javax.swing.GroupLayout.PREFERRED_SIZE, 81, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void AddBasketButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddBasketButtonActionPerformed
        for(int y=1;y<=l1;y++) {
            try {
                ...
                Quantity.setText(c+"");
                pst.setString(1,c+"");
                pst.setString(2,"Vanilla Reduced Fat Ice Cream");
                pst.setInt(3,(total/l1));
                pst.setString(4,m1+m2);
   ...
   try {writer.close();} catch (Exception ex) {}
    ...
    private void Ingredient1CheckActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Ingredient1CheckActionPerformed
        if(a1==1) {
            ...
            total=total+500*l1;
            TotalPrice.setText(total+"₮");
            m1="VANILLA REDUCED FAT ICE CREAM\n";
        }
    ...
    private void MinusButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MinusButtonActionPerformed
        ...
        if(c1==1) {
            total=l1*(2000-(orts1+orts2));
            TotalPrice.setText(total+"");
        }
        if(c2==1) {
            total=l1*(3000-(orts1+orts2));
            TotalPrice.setText(total+"");
        }
        if(c3==1) {
            total=l1*(5000-(orts1+orts2));
            TotalPrice.setText(total+"");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Customize4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Customize4().setVisible(true);
            }
        });
    }
