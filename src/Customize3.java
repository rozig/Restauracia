...
public class Customize3 extends javax.swing.JFrame {
    int a1=1,a2=1,a3=1,a4=1,a5=1,total=8000,orts1=0,orts2=0,orts3=0,orts4=0,orts5=0,l1=1,c1=0,c2=1,c3=0,c;
    Connection conn = null;
    ResultSet rs = null;
    PreparedStatement pst=null;
    String m1="FLOUR TORTILLA\n",m2="CRISPY CHICKEN FILLET\n",m3="SHREDDED CHEDDAR\n",m4="SHREDDED LETTUCE\n",m5="CHIPOLETE BBQ SAUCE\n",n1="",n2="Дунд",n3="";
    public Customize3() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Order/s-mcdonalds-Chipotle-BBQ-Snack-Wrap-Crispy.png"))); // NOI18N

        IngredientPanel.setBorder(javax.swing.BorderFactory.createTitledBorder("Орц"));

        Ingredient1Check.setSelected(true);
        Ingredient1Check.setText("FLOUR TORTILLA");
        ...
        Ingredient2Check.setText("CRISPY CHICKEN FILLET");
        ...
        Ingredient3Check.setText("SHREDDED CHEDDAR");
        ...
        Ingredient5Check.setText("CHIPOTLE BBQ SAUCE");
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(IngredientPanel, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
	...
	RadioBig.setSelected(false);
        total=(5000-(orts1+orts2+orts3+orts4+orts5))*l1;
        TotalPrice.setText(total+"₮");
        n1="Жижиг";
        n2="";
        n3="";
    ...
    private void AddBasketButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddBasketButtonActionPerformed
        for(int y=1;y<=l1;y++) {
            try {
                ...
                Quantity.setText(c+"");
                pst.setString(1,c+"");
                pst.setString(2,"Chipotle BBQ Snack");
...
try {
  ...
  // report
   ...
   try {writer.close();} catch (Exception ex) {}
	...
	RadioBig.setSelected(false);
        total=(8000-(orts1+orts2+orts3+orts4+orts5))*l1;
        TotalPrice.setText(total+"₮");
        n1="";
        n2="Дунд";
        n3="";
    ...
    private void MinusButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MinusButtonActionPerformed
        ...
        if(c1==1) {
            total=l1*(5000-(orts1+orts2+orts3+orts4+orts5));
            TotalPrice.setText(total+"");
        }
        if(c2==1) {
            total=l1*(8000-(orts1+orts2+orts3+orts4+orts5));
            TotalPrice.setText(total+"");
        }
        if(c3==1) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Customize3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Customize3().setVisible(true);
            }
        });
    }
