...
public class Customize5 extends javax.swing.JFrame {
    int a1=1,a2=1,a3=1,a4=1,total=3000,orts1=0,orts2=0,orts3=0,orts4=0,l1=1,c1=0,c2=1,c3=0,c;
    Connection conn = null;
    ResultSet rs = null;
    PreparedStatement pst=null;
    String m1="FLOUR TORTILLA\n",m2="CRISPY CHICKEN FILLET\n",m3="SHREDDED CHEDDAR\n",m4="SHREDDED LETTUCE\n",n1="",n2="Дунд",n3="";
    public Customize5() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Fruit 'n Yogurt Parfait");
        setResizable(false);
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Order/s-mcdonalds-Fruit-n-Yogurt-Parfait-7-oz.png"))); // NOI18N

        IngredientPanel.setBorder(javax.swing.BorderFactory.createTitledBorder("Орц"));

        Ingredient1Check.setSelected(true);
        Ingredient1Check.setText("LOWFAT YOGURT");
        ...
        Ingredient2Check.setText("STRAWBERRIES");
        ...
        Ingredient3Check.setText("BLUEBERRIES");
        ...
        Ingredient4Check.setText("LOW FAT CRUNCHY GRANOLA");
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(IngredientPanel, javax.swing.GroupLayout.PREFERRED_SIZE, 123, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
	...
	RadioBig.setSelected(false);
        total=(2000-(orts1+orts2+orts3+orts4))*l1;
        TotalPrice.setText(total+"₮");
        n1="Жижиг";
        n2="";
        n3="";
    ...
    private void AddBasketButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddBasketButtonActionPerformed
        for(int y=1;y<=l1;y++) {
            try {
                ...
                Quantity.setText(c+"");
                pst.setString(1,c+"");
                pst.setString(2,"Fruit 'n Yogurt Parfait");
                pst.setInt(3,(total/l1));
                pst.setString(4,m1+m2+m3+m4);
...
try {
  ...
  // report
   ...
   try {writer.close();} catch (Exception ex) {}
	...
	RadioBig.setSelected(false);
        total=(3000-(orts1+orts2+orts3+orts4))*l1;
        TotalPrice.setText(total+"₮");
        n1="";
        n2="Дунд";
        n3="";
    ...
    private void RadioBigActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RadioBigActionPerformed
        ...
        RadioMedium.setSelected(false);
	RadioSmall.setSelected(false);
        total=(5000-(orts1+orts2+orts3+orts4))*l1;
        TotalPrice.setText(total+"₮");
        n1="";
        n2="";
        n3="Том";
    ...
    private void MinusButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MinusButtonActionPerformed
        ...
        if(c1==1) {
            total=l1*(2000-(orts1+orts2+orts3+orts4));
            TotalPrice.setText(total+"");
        }
        if(c2==1) {
            total=l1*(3000-(orts1+orts2+orts3+orts4));
            TotalPrice.setText(total+"");
        }
        if(c3==1) {
            total=l1*(5000-(orts1+orts2+orts3+orts4));
            TotalPrice.setText(total+"");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Customize5.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Customize5().setVisible(true);
            }
        });
    }
