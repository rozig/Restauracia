...
public class Customize6 extends javax.swing.JFrame {
    int a1=1,a2=1,total=2000,orts1=0,orts2=0,l1=1,c1=0,c2=1,c3=0,c;
    Connection conn = null;
    ResultSet rs = null;
    PreparedStatement pst=null;
    String m1="WHOLE MILK\n",m2="ESPRESSO\n",n1="",n2="Дунд",n3="";
    public Customize6() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Order/s-mcdonalds-McCaf-Latte-Small.png"))); // NOI18N

        IngredientPanel.setBorder(javax.swing.BorderFactory.createTitledBorder("Орц"));

        Ingredient1Check.setSelected(true);
        Ingredient1Check.setText("WHOLE MILK");
        ...
        Ingredient2Check.setText("ESPRESSO");
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(IngredientPanel, javax.swing.GroupLayout.PREFERRED_SIZE, 80, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
   ...
   try {writer.close();} catch (Exception ex) {}
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Customize6.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Customize6().setVisible(true);
            }
        });
    }
